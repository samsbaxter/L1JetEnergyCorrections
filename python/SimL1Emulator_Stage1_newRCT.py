...
if new_layer2_LUT:
    process.caloStage1Params.jetCalibrationLUTFile = cms.FileInPath("L1Trigger/L1JetEnergyCorrections/data/Jet_Stage1_2015_v3.txt")
    file_append += "_stage1v3"
    # process.caloStage1Params.jetCalibrationLUTFile = cms.FileInPath("L1Trigger/L1JetEnergyCorrections/data/Stage1_HFfix_PU15to25_rctV4.txt")
    # file_append += "_stage1HFfix"
else:
