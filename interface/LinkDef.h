...
#pragma link C++ class std::vector<MatchedPair>+;
 ...
 * rootcint -f dictionary.cpp -c MatchedPair.h TLorentzVector.h ../../../L1TriggerDPG/L1Ntuples/interface/L1AnalysisL1ExtraDataFormat.h LinkDef.h && mv dictionary.cpp ../src/
