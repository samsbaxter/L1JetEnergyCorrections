...
class MultiFunc(object):
    ...
    def Mod(self):
        """If we want to do any sort of styling, need to access the last drawn func"""
        return self.funcs[0]
...
class Plot(object):
    ...
    def __init__(self, contributions=None, what="graph",
        ...
        what: str. Options are "graph", "function", "both".
...
def compare():
    ...
    # "New" = with HF fix
    f_jetSeed0_new_0PU = os.path.join(d, 'Stage1_QCDFlatSpring15BX25HCALFix_stage1NoLut_rctv4_jetSeed0/output/output_QCDFlatSpring15BX25FlatNoPUHCALFix_Stage1_MCRUN2_74_V9_jetSeed0_noStage1Lut_rctv4_preGt_ak4_ref14to1000_l10to500_dr0p7.root')
    f_jetSeed5_new_0PU = os.path.join(d, 'Stage1_QCDFlatSpring15BX25HCALFix_stage1NoLut_rctv4_jetSeed5/output/output_QCDFlatSpring15BX25FlatNoPUHCALFix_Stage1_MCRUN2_74_V9_jetSeed5_noStage1Lut_rctv4_preGt_ak4_ref14to1000_l10to500_dr0p7.root')

    # New spring 15 MC, jet seed0, binned by PU
    f_jetSeed0_new_PU0to10 = os.path.join(d, "Stage1_QCDFlatSpring15BX25HCALFix_stage1NoLut_rctv4_jetSeed0/output/output_QCDFlatSpring15BX25PU10to30HCALFix_Stage1_MCRUN2_74_V9_jetSeed0_noStage1Lut_rctv4_preGt_ak4_ref14to1000_l10to500_dr0p7_PU0to10.root")
    f_jetSeed0_new_PU15to25 = os.path.join(d, "Stage1_QCDFlatSpring15BX25HCALFix_stage1NoLut_rctv4_jetSeed0/output/output_QCDFlatSpring15BX25PU10to30HCALFix_Stage1_MCRUN2_74_V9_jetSeed0_noStage1Lut_rctv4_preGt_ak4_ref14to1000_l10to500_dr0p7_PU15to25.root")
    f_jetSeed0_new_PU30to40 = os.path.join(d, "Stage1_QCDFlatSpring15BX25HCALFix_stage1NoLut_rctv4_jetSeed0/output/output_QCDFlatSpring15BX25PU10to30HCALFix_Stage1_MCRUN2_74_V9_jetSeed0_noStage1Lut_rctv4_preGt_ak4_ref14to1000_l10to500_dr0p7_PU30to40.root")

    # New spring 15 MC, jet seed5, binned by PU
    f_jetSeed5_new_PU0to10 = os.path.join(d, "Stage1_QCDFlatSpring15BX25HCALFix_stage1NoLut_rctv4_jetSeed5/output/output_QCDFlatSpring15BX25PU10to30HCALFix_Stage1_MCRUN2_74_V9_jetSeed5_noStage1Lut_rctv4_preGt_ak4_ref14to1000_l10to500_dr0p7_PU0to10.root")
    f_jetSeed5_new_PU15to25 = os.path.join(d, "Stage1_QCDFlatSpring15BX25HCALFix_stage1NoLut_rctv4_jetSeed5/output/output_QCDFlatSpring15BX25PU10to30HCALFix_Stage1_MCRUN2_74_V9_jetSeed5_noStage1Lut_rctv4_preGt_ak4_ref14to1000_l10to500_dr0p7_PU15to25.root")
    f_jetSeed5_new_PU30to40 = os.path.join(d, "Stage1_QCDFlatSpring15BX25HCALFix_stage1NoLut_rctv4_jetSeed5/output/output_QCDFlatSpring15BX25PU10to30HCALFix_Stage1_MCRUN2_74_V9_jetSeed5_noStage1Lut_rctv4_preGt_ak4_ref14to1000_l10to500_dr0p7_PU30to40.root")
    ...
    for i, (eta_min, eta_max) in enumerate(zip(binning.eta_bins[:-1], binning.eta_bins[1:])):
        ...
        p = Plot(contributions=graphs, what="both", xtitle="<p_{T}^{L1}>", ytitle="Correction value (= 1/response)",
                 title="Original Spring15 MC + no JEC, 25ns, PU20, %g < |#eta| < %g" % (eta_min, eta_max))
        p.plot()
        ...
        p = Plot(contributions=graphs, what="both", xtitle="<p_{T}^{L1}>", ytitle="Correction value (= 1/response)",
                 title="No JEC, 25ns, jet seed 5, %g < |#eta| < %g" % (eta_min, eta_max))
        p.legend.SetX1(0.5)
        p.legend.SetY1(0.6)
        p.plot()
