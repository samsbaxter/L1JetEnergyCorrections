...
The datasets must be the name of their keys in the samples dict (or mc_scamples or data_samples)
"""
...
if __name__ == "__main__":
    ...
    for dset in datasets:
        ...
        print scriptName
        cmsRunCondor(['--config', config, '--outputDir', outputDir+"/"+dset, '--dataset', dset_opts.inputDataset, '--filesPerJob', str(dset_opts.unitsPerJob), '--totalFiles', str(totalUnits), '--outputScript', scriptName, "--verbose"])
